<template>
		...
		<!-- #endif -->
			<view class="content-box">
				<view class="nav-bar" style="position: relative; box-sizing: border-box; box-sizing: border-box; width: 100vw; height: 44px;">
					...
					<text class="title" style="font-size: 16px; position:absolute; left: 50%; top:50%; transform: translate(-50%,-50%);">收样信息</text>
				</view>
	...
	<selectReceive ref='selectSendRef' @emitVisible='(val)=>mainVisible=val'></selectReceive>
</template>
