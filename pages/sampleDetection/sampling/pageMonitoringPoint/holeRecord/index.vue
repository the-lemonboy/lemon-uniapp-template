	...
	<view class="mo-container">
		<uni-table border  emptyText="暂无更多数据" >
				...
				<uni-tr  v-for="item of dataList" >
					<uni-td @click="goAddOrEditor(item.id)"  align="center">{{item.solumType}}</uni-td>
					<uni-td align="center">{{item.solumType}}</uni-td>
				</uni-tr>
			</uni-table>
	</view>
</template>
...
<script setup>
	...
	import { getHoleRecordList } from '@/api/sample.js'
